    ...
    <>
      ...
      >
        ...
        <Section id="your-rights" title="6. Your Rights">
          ...
          <p>To make a request, email us at <a href="mailto:privacy@primeprojects.pro" className="text-olive hover:underline">privacy@primeprojects.pro</a>. We will respond within 30 days.</p>
        ...
        <Section id="contact" title="10. Contact Us">
          ...
          <p>
            ...
            Email: <a href="mailto:privacy@primeprojects.pro" className="text-olive hover:underline">privacy@primeprojects.pro</a>
          </p>
        </Section>
      </LegalLayout>
    </>
